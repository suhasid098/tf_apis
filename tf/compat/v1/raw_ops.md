...
[`RandomIndexShuffle(...)`](../../../tf/raw_ops/RandomIndexShuffle.md): Outputs the position of `value` in a permutation of [0, ..., max_index].
...
[`TPUPartitionedInput(...)`](../../../tf/raw_ops/TPUPartitionedInput.md): An op that groups a list of partitioned inputs together. This op

[`TPUPartitionedOutput(...)`](../../../tf/raw_ops/TPUPartitionedOutput.md): An op that demultiplexes a tensor to be sharded by XLA to a list of partitioned
...
[`TensorScatterMax(...)`](../../../tf/raw_ops/TensorScatterMax.md): Apply a sparse update to a tensor taking the element-wise maximum.
...
[`WriteFile(...)`](../../../tf/raw_ops/WriteFile.md): Writes `contents` to the file at input `filename`.
