description: Built-in optimizer classes.
...
[`experimental`](../../tf/keras/optimizers/experimental.md) module: Public API for tf.keras.optimizers.experimental namespace.

[`legacy`](../../tf/keras/optimizers/legacy.md) module: Public API for tf.keras.optimizers.legacy namespace.
