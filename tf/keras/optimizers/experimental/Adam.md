...
<meta itemprop="name" content="tf.keras.optimizers.experimental.Adam" />
...
<td>
  <a target="_blank" href="https://github.com/keras-team/keras/tree/v2.9.0/keras/optimizers/optimizer_experimental/adam.py#L25-L193">
...
<code>tf.keras.optimizers.experimental.Adam(
    learning_rate=0.001,
    beta_1=0.9,
    beta_2=0.999,
    epsilon=1e-07,
