...
<meta itemprop="name" content="tf.keras.optimizers.experimental.RMSprop" />
...
<td>
  <a target="_blank" href="https://github.com/keras-team/keras/tree/v2.9.0/keras/optimizers/optimizer_experimental/rmsprop.py#L25-L190">
...
<code>tf.keras.optimizers.experimental.RMSprop(
    learning_rate=0.001,
    rho=0.9,
    momentum=0.0,
    epsilon=1e-07,
