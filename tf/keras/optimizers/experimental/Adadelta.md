...
<meta itemprop="name" content="tf.keras.optimizers.experimental.Adadelta" />
...
<td>
  <a target="_blank" href="https://github.com/keras-team/keras/tree/v2.9.0/keras/optimizers/optimizer_experimental/adadelta.py#L25-L137">
...
<code>tf.keras.optimizers.experimental.Adadelta(
    learning_rate=0.001,
    rho=0.95,
    epsilon=1e-07,
    clipnorm=None,
