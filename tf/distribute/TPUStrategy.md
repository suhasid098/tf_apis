...
<a target="_blank" class="external" href="/code/stable/tensorflow/python/distribute/tpu_strategy.py">View source</a>
...
<a href="../../tf/distribute/TPUStrategy.md#experimental_assign_to_logical_device"><code>tf.distribute.TPUStrategy.experimental_assign_to_logical_device</code></a> will
...
<a href="../../tf/distribute/TPUStrategy.md"><code>tf.distribute.TPUStrategy</code></a> provides the associated
<a href="../../tf/distribute/cluster_resolver/ClusterResolver.md"><code>tf.distribute.cluster_resolver.ClusterResolver</code></a>. If the user provides one
